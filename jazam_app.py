...
""")
        ...
        with col_p1:
            st.markdown('<div class="rule-box" style="text-align:center;"><span style="font-size:1.4rem;">⚫</span><br><b>14 Negras</b><br><small>El rival coloca 1 pieza en su próximo turno</small></div>', unsafe_allow_html=True)
        with col_p2:
            st.markdown('<div class="rule-box" style="text-align:center;"><span style="font-size:1.4rem;">🟡</span><br><b>8 Blancas</b><br><small>El rival coloca 2 piezas en su próximo turno</small></div>', unsafe_allow_html=True)
        with col_p3:
...
""")
        ...
        col_p1, col_p2, col_p3 = st.columns(3)
        with col_p1:
            st.markdown('<div class="rule-box" style="text-align:center;"><span style="font-size:1.4rem;">⚫</span><br><b>14 Black</b><br><small>Opponent places 1 bead on their next turn</small></div>', unsafe_allow_html=True)
        with col_p2:
            st.markdown('<div class="rule-box" style="text-align:center;"><span style="font-size:1.4rem;">🟡</span><br><b>8 White</b><br><small>Opponent places 2 beads on their next turn</small></div>', unsafe_allow_html=True)
        with col_p3:
