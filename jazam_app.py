    ...
    for li in range(6):
        ...
        for si in range(n):
            ...
            if cell is not None:
                ...
                p = cell["p"]
                pr = r_dot - 2
                # Negra: casi negro con borde gris claro para que se vea el contorno
                # Blanca: gris medio con borde oscuro para distinguirse del fondo crema
                # Azul: azul vibrante con borde azul oscuro
                pf = {"black": "#1A1A18", "white": "#C8C4B8", "blue": "#378ADD"}[t]
                ps = {"black": "#555550", "white": "#6B6860", "blue": "#185FA5"}[t]
...
# ── Pestañas ──────────────────────────────────────────────────────────────────
tab_game, tab_rules = st.tabs(["🎮 Juego", "📖 Reglas"])
