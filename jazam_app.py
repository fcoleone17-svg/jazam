...
with tab_rules:
    ...
    if ES:
        ...
        st.markdown('<div class="rule-box">🟡 Después de una <b>blanca</b>, el próximo que avance por ese lado pone 2 pelotas. Ojo: la primera no cuenta — solo ocupa el espacio. La segunda es la que realmente juega.<br><br><b>Ejemplo:</b> la blanca queda justo antes de un espacio celeste. El siguiente jugador coloca primero una pelota cualquiera (solo rellena). Luego coloca la segunda — si es azul en el celeste, sí sube de nivel y gana los puntos.</div>',unsafe_allow_html=True)
        st.divider()
